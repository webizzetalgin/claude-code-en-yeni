...
2. **Referansın başlık hiyerarşisini uygula** (tüm alt başlıklar h2 olacak)
...
Kullanıcı hangi metni verdiyse yalnızca o metin kullanılır — ekleme, süsleme, açıklama veya
ek alt başlık oluşturma YASAKTIR. İçerik birebir kullanıcıdan gelir, senin görevin yalnızca
bu içeriği referans tasarımın görsel diline uygun şekilde yerleştirmektir.
