...
## Adım 2: İçerik Uzunluğu ve Strateji Belirleme

H1 başlığındaki **kelime sayısına** göre iki kuraldan birini uygula:

### Kural A — H1 Başlığı 1 veya 2 Kelime İse (Geniş Kapsamlı İçerik)

| Parametre | Değer |
|-----------|-------|
| Kelime Hedefi | 1500–2000 kelime |
| Araştırma Derinliği | SERP sonuçları + rakip içerik mantığı derinlemesine analiz |
| Kapsam | Konuyu tüm alt başlıklarıyla, detaylı ve doyurucu şekilde ele al |
| İç Link | Minimum 3, Maksimum 7 adet |

### Kural B — H1 Başlığı 3+ Kelime İse (Odaklı İçerik)

| Parametre | Değer |
|-----------|-------|
| Kelime Hedefi | Minimum 500-550 | Maksimum 600–650 kelime |
| Araştırma Derinliği | SERP sonuçlarını incele ama konuyu dağıtma |
| Alt Başlıklar | "People Also Ask" bölümünden maksimum 4 soru → H2/H3 olarak kullan |
| İç Link | Minimum 2, Maksimum 3 adet |

---

## Adım 3: SERP Araştırması

Her H1 başlığı için şu web araştırmasını yap:

1. **Ana SERP Araması:** H1 kelime öbeğini `web_search` ile ara.
2. **Rakip Analizi:** İlk 3–5 sonucun içerik yapısını `web_fetch` ile incele (başlık hiyerarşisi, kapsam, kelime sayısı).
3. **People Also Ask:** "People Also Ask" / "Kullanıcılar bunları da sordu" sorularını tespit et.
4. **Alt Başlık Fikirleri:** Rakiplerin kullandığı H2/H3 başlıklarını not al ve kendi alt başlıklarını bu verilerden türet.
...
|-------------|-------------|---------------|
| 1500–2000 kelime (Kural A) | 3 | 7 |
| 600–650 kelime (Kural B) | 2 | 3 |
...
2. **Kelime sınırlarına kesinlikle uy.** Kural A: 1500–2000 / Kural B: 600–650.
...
Kullanıcı H1 başlıklarını verir
        ↓
Kelime sayısı analizi (1-2 kelime → Kural A / 3+ kelime → Kural B)
        ↓
